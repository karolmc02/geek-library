...
public class Manga extends Work {
  ...
  public Manga(final UUID id, final String title, final String description, final Person author, final Person illustrator) {
    super(id, title, description, author, illustrator);
  }

  public Manga(final String title, final String description, final Person author, final Person illustrator) {
