...
public record CreateEditionCommand(UUID workId, String publisher, LanguageTO language,
        CountryTO country, Boolean isOriginal, FormatTO format, ColorMode colorMode) {
}
