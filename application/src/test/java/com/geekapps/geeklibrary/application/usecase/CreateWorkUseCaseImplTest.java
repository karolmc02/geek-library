...
class CreateWorkUseCaseImplTest {
        ...
        void setUp() {
                ...
                this.command = new CreateWorkCommand(WorkType.MANGA, "One Piece",
                                "A pirate adventure", authorCommand, illustratorCommand);
        ...
        void shouldCreateWorkWithNullIllustrator() {
                ...
                Mockito.when(this.personRepository.findById(authorCommand.id()))
                                .thenReturn(authorPerson);
                Mockito.when(this.workRepository.save(ArgumentMatchers.any(Work.class)))
