...
class CreateVolumeUseCaseImplTest {
        ...
        void setUp() {
                ...
                this.command = new CreateVolumeCommand(this.workId, this.editionId, "Volume 1", 1,
                                priceTO, LocalDate.of(2024, 1, 15), "978-1-2345-6789-0", 200);
        ...
        void shouldCreateVolumeSuccessfullyWithValidData() {
                ...
                Assertions.assertThat(result.getPublicationDate())
